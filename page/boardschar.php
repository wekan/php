...
if (isset($_GET["boardschar"])) {
  ...
  echo "<h2>No boardschar value</h2></body></html>"
  die();
}
...
<?php
$type = "board";
$statement = $db->prepare("SELECT _id, title, type from boards WHERE type=:type AND title LIKE ':boardschar%' ORDER BY title ASC;");

$statement->bindValue(':type', $type);
$statement->bindValue(':boardschar', $boardschar);
